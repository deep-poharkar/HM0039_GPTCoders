...
import Image from "../../svgs/SVG/SVG/MentalHealth.svg";
  ...
  return (
    <div className={styles.homepageContainer}>
      <header>
        <div className={styles.logoContainer}>
          ...
          <div className={styles.headerText}>
            <h4 className={styles.text}>TraqLinq</h4>
      ...
      <section className="mt-8" ref={articles}>
        <h1 className="text-center text-3xl font-bold">Recommended Articles</h1>
